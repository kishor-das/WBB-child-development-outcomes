...
table_2<-rbind(com_glue,com_df,mot_glue,mot_df,per_glue,per_df,combined_glue,combined_df)

save(table_2,file="C:\\Users\\kdas\\Dropbox\\WASHB-cognitive-development-analysis\\results\\table-2.Rdata")
