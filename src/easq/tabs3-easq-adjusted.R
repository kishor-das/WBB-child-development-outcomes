...
easq<-  read.dta("C:\\Users\\kdas\\Dropbox\\WASHB-cognitive-development-datasets\\washb-bangladesh-easq-year2.dta")
enrol<- read.dta("C:\\Users\\kdas\\Dropbox\\WASHB-cognitive-development-datasets\\washb-bangladesh-enrol.dta")
...
cov_adj_3<-c("agedays","month","fracode","sex","momage","momedu","momheight","hfiacat","Nlt18","Ncomp","watmin","elec","floor","walls","roof","asset_wardrobe","asset_table","asset_chair","asset_khat","asset_chouki","asset_tv","asset_refrig","asset_bike","asset_moto","asset_sewmach","asset_mobile","z_home","z_momdep")
...
save(table_s3,file="C:\\Users\\kdas\\Dropbox\\WASHB-cognitive-development-analysis\\results\\table-s3.Rdata")