...
for(arm in group){
  standsupp_col_2[arm]<-dformat(sum(!is.na(whomm[whomm$arm==arm,]$stand_supp)),0)
...
for(arm in group[2:7]){
  reg<- whomm_gam(Y=whomm$stand_supp,childage=whomm$agedays,tr=whomm$arm,contrast=c("Control",arm), W=NULL, pval=0.1)
...
for(arm in group[7]){
  reg<-  whomm_gam(Y=whomm$stand_supp,childage=whomm$agedays,tr=whomm$arm,contrast=c("WSH",arm), W=NULL, pval=0.1)
  hr<- dformat(reg[[1]][[1]],2)
  lcb<- dformat(reg[[1]][[3]],2) 
  ucb<- dformat(reg[[1]][[4]],2)  
...
for(arm in group[7]){
  reg<- whomm_gam(Y=whomm$stand_supp,childage=whomm$agedays,tr=whomm$arm,contrast=c("Nutrition",arm), W=NULL, pval=0.1)
...
#----------------------------------
#Hands and knees crawling analysis
#----------------------------------
# column 1
...
for(arm in group){
  handsknee_col_2[arm]<-dformat(sum(!is.na(whomm[whomm$arm==arm,]$crawl_nosupp)),0)
...
for(arm in group[2:7]){
  reg<- whomm_gam(Y=whomm$crawl_nosupp,childage=whomm$agedays,tr=whomm$arm,contrast=c("Control",arm), W=NULL, pval=0.1)
  hr<- dformat(reg[[1]][[1]],2)
  lcb<- dformat(reg[[1]][[3]],2) 
  ucb<- dformat(reg[[1]][[4]],2)
...
for(arm in group[7]){
  reg<-  whomm_gam(Y=whomm$crawl_nosupp,childage=whomm$agedays,tr=whomm$arm,contrast=c("WSH",arm), W=NULL, pval=0.1)
  hr<- dformat(reg[[1]][[1]],2)
  lcb<- dformat(reg[[1]][[3]],2) 
  ucb<- dformat(reg[[1]][[4]],2)  
...
for(arm in group[7]){
  reg<- whomm_gam(Y=whomm$crawl_nosupp,childage=whomm$agedays,tr=whomm$arm,contrast=c("Nutrition",arm), W=NULL, pval=0.1)
  dif<- dformat(reg[[1]][[1]],2)
  lcb<- dformat(reg[[1]][[3]],2) 
  ucb<- dformat(reg[[1]][[4]],2)  
...
#---------------------------
#Walking with assistance analysis
#---------------------------
#column 1
walksupp_col_1<-c(
  "\u005cMyIndent Control",
...
walksupp_col_2<-NULL
for(arm in group){
  walksupp_col_2[arm]<-dformat(sum(!is.na(whomm[whomm$arm==arm,]$walk_supp)),0)
...
for(arm in group[2:7]){
  reg<- whomm_gam(Y=whomm$walk_supp,childage=whomm$agedays,tr=whomm$arm,contrast=c("Control",arm), W=NULL, pval=0.1)
  hr<- dformat(reg[[1]][[1]],2)
  lcb<- dformat(reg[[1]][[3]],2) 
  ucb<- dformat(reg[[1]][[4]],2)
...
for(arm in group[7]){
  reg<-  whomm_gam(Y=whomm$walk_supp,childage=whomm$agedays,tr=whomm$arm,contrast=c("WSH",arm), W=NULL, pval=0.1)
  hr<- dformat(reg[[1]][[1]],2)
  lcb<- dformat(reg[[1]][[3]],2) 
  ucb<- dformat(reg[[1]][[4]],2)  
...
for(arm in group[7]){
  reg<- whomm_gam(Y=whomm$walk_supp,childage=whomm$agedays,tr=whomm$arm,contrast=c("Nutrition",arm), W=NULL, pval=0.1)
  dif<- dformat(reg[[1]][[1]],2)
  lcb<- dformat(reg[[1]][[3]],2) 
  ucb<- dformat(reg[[1]][[4]],2)  
...
for(arm in group){
  standalone_col_2[arm]<-dformat(sum(!is.na(whomm[whomm$arm==arm,]$stand_nosupp)),0)
...
for(arm in group[2:7]){
  reg<- whomm_gam(Y=whomm$stand_nosupp,childage=whomm$agedays,tr=whomm$arm,contrast=c("Control",arm), W=NULL, pval=0.1)
  hr<- dformat(reg[[1]][[1]],2)
  lcb<- dformat(reg[[1]][[3]],2) 
  ucb<- dformat(reg[[1]][[4]],2)
...
for(arm in group[7]){
  reg<-  whomm_gam(Y=whomm$stand_nosupp,childage=whomm$agedays,tr=whomm$arm,contrast=c("WSH",arm), W=NULL, pval=0.1)
  hr<- dformat(reg[[1]][[1]],2)
  lcb<- dformat(reg[[1]][[3]],2) 
  ucb<- dformat(reg[[1]][[4]],2)  
...
for(arm in group[7]){
  reg<- whomm_gam(Y=whomm$stand_nosupp,childage=whomm$agedays,tr=whomm$arm,contrast=c("Nutrition",arm), W=NULL, pval=0.1)
  dif<- dformat(reg[[1]][[1]],2)
  lcb<- dformat(reg[[1]][[3]],2) 
  ucb<- dformat(reg[[1]][[4]],2)  
...
for(arm in group){
  walkalone_col_2[arm]<-dformat(sum(!is.na(whomm[whomm$arm==arm,]$walk_nosupp)),0)
...
for(arm in group[2:7]){
  reg<- whomm_gam(Y=whomm$walk_nosupp,childage=whomm$agedays,tr=whomm$arm,contrast=c("Control",arm), W=NULL, pval=0.1)
  hr<- dformat(reg[[1]][[1]],2)
  lcb<- dformat(reg[[1]][[3]],2) 
  ucb<- dformat(reg[[1]][[4]],2)
...
for(arm in group[7]){
  reg<-  whomm_gam(Y=whomm$walk_nosupp,childage=whomm$agedays,tr=whomm$arm,contrast=c("WSH",arm), W=NULL, pval=0.1)
  hr<- dformat(reg[[1]][[1]],2)
  lcb<- dformat(reg[[1]][[3]],2) 
  ucb<- dformat(reg[[1]][[4]],2)  
...
for(arm in group[7]){
  reg<- whomm_gam(Y=whomm$walk_nosupp,childage=whomm$agedays,tr=whomm$arm,contrast=c("Nutrition",arm), W=NULL, pval=0.1)
  dif<- dformat(reg[[1]][[1]],2)
  lcb<- dformat(reg[[1]][[3]],2) 
  ucb<- dformat(reg[[1]][[4]],2)  
...
save(who_motor,file="C:\\Users\\kdas\\Dropbox\\WASHB-cognitive-development-analysis\\results\\raw\\who-motor.Rdata")
